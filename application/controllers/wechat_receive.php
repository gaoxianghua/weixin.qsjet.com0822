...
class Wechat_receive extends CI_Controller
{
    ...
    {
        //access_token
        $token = '12_HqU3Az2ZX3KKggKlcehvJEFEiiwhQ2-l8W9mv-no1Jq6kRBVmIQVMyh29YagxOb8Pm68nImPnFjZ4u4D64W5zcrWgiqIXAEliw3lf5G4sgGHgWws9dtglidpUr47EJU9XsG7LaFHN_owEF8jOWPaAHAAIB';
...
<xml><ToUserName><![CDATA[%s]]></ToUserName><FromUserName><![CDATA[%s]]></FromUserName><CreateTime>%s</CreateTime><MsgType><![CDATA[%s]]></MsgType><Image><MediaId><![CDATA[%s]]></MediaId></Image></xml>";
            if ("connect" == $obj->EventKey) {
                $mediaId = "Q7h9DNH79WEsuYNJa_OP5mW52ulOKVlPY8B2HZT03gI";
